...
class Cards extends StatelessWidget {
  ...
  final String firstitemgoal;
  final String seconditem;
  final String seconditemvalue;
  final String seconditemgoal;
  final String notificationtext;
  final Widget graphimage;
  final ontap;
  ...
  const Cards(
      ...
      required this.firstitemgoal,
      required this.seconditemgoal,
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(color: AppColors.secondcontainerboder),
                      borderRadius: BorderRadius.circular(10)),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
